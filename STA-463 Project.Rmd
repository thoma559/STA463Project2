...
First, we will change the categorical predictors to be binary variables (0's and 1's) (rank will have 3 levels: 1, 2, 3). A Professor is level 3, an Assistant Professor is level 2, and an Associate Professor is 1:
```{r}
