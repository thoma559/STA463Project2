...
From this interval, we are 95% confident that for every one year increase in service, the increase in the mean salary of professors of a particular gender in applied field would be between 288.93 and 1135.56 dollars more than the increase in the mean salary of professors of the same gender in the theoretical field. 
...
## Conclusion
Based on our results, we can conclude that the increase in salary per year of service is higher for professors within the applied field as compared to professors in the theoretical field. This means 
