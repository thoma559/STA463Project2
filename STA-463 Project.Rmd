...
## Each report should set out to do one of two things: (We will delete this part later, I just wanted to add the instructions in)
...
head(nbadata)
```
Include a description of your hypothesis/question or predictive approach
...
The hypothesis we will explore in this project is _________.
